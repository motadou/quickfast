...
public:
    ...
    void decodeMessage(DataSource & source, Messages::ValueMessageBuilder & message);
    ...
    void decodeGroup(DataSource & source, const SegmentBodyCPtr & segment, Messages::ValueMessageBuilder & messageBuilder);
    ...
    void decodeNestedTemplate(DataSource & source, Messages::ValueMessageBuilder & messageBuilder, const Messages::FieldIdentity & identity);
